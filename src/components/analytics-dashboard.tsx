        ...
        <Card className="border-none shadow-sm bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-black text-slate-900">₹{operations.restaurantRev?.toLocaleString('en-IN') || 0}</p>
            </div>
          </div>
        </Card>
        <Card className="border-none shadow-sm bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-black text-slate-900">{operations.activeOrders || 0}</p>
            </div>
          </div>
        </Card>
      </div>
